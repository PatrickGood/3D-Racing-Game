...
public class LoadCatModel{
		//Models
			...
			void drawCatModel(GL2 gl, float WRot, float CatH, float CatS)
			{
				...
				gl.glRotatef(WRot, 0.0f, 1.0f, 0.0f);
			...
			void drawCatBodyModel( GL2 gl ) {
			    ...
			    for ( int i = 0; i < my_cat.faces.size(); ++i ) {
			        ...
			        String currentmaterialName = my_cat.faces.get( i ).material.name;
			        ...
			        if(foundmaterialIndex==list_size) {
			        	...
			        	BufferedImage materialImage = ImageIO.read(new File("models/cat/"+filename));
			        ...
			        float materialColor[] = {1.0f, 0.3f, 0.0f, 1.0f};
			         ...
			         float materialEmission[] = {0.8f,0.3f,0.0f, 0.0f};
